...
class SearchWindow
{
     ...
     * @var String $sourceFieldOption
     */

	 private $sourceFieldOption;
    ...
    public function __construct()
    {
        if(isset($_POST['optionS']))
            $this->optionField = $_POST['optionS'];
        if(isset($_POST['url']))
            $this->url = $_POST['url'];
        if(isset($_POST['key']))
        ...
        if(isset($_POST['summarization']))
            $this->summarization = $_POST['summarization'];
        if(isset($_POST['sourceSearch']))
            $this->sourceFieldOption = $_POST['sourceSearch'];
        if(isset($_POST['socialNetwork']))
            $this->socialNetwork = $_POST['socialNetwork'];
        if(isset($_POST['baseType']))
            $this->chooseDataSetType = $_POST['baseType'];
    }
     ...
     * @return mixed
     */
    public function getChooseDataSetType()
    {
        return $this->chooseDataSetType;
    }
    ...
    public function cleanTemporaryFiles()
    {
        if(isset($this->searchButton))
        {
            ...
            {
                unlink('type search.txt');
            }
            if(file_exists('urls.txt'))
            {
                unlink('urls.txt');
            }
            if(file_exists('summarized.txt'))
            {
                unlink('summarized.txt');
            }
    ...
    public function searchMode()
    {
        if (isset($this->searchButton))
        {
			...
			{
				echo("<script>alert('A busca não retornou resultados! Tente modificar os parâmetros!');</script>");
