...
class SpecificSearch extends Search
{
    ...
    {
        if(($this->Search->getOptionField() == '2' && $this->Search->getSourceFieldOption()=='sim' && $this->Search->getKeywordsField()!="" && $this->Search->getSearchEngineField()!='0' && $this->Search->getYearField()!='0' && $this->Search->getSourceField()!='0' && $this->Search->getSummarization()!='0'))
        {
            return true;
        }
        else
