...
abstract class Search
{
    ...
    public function writeDegreeOfCompressionField($degree)
   {
    ...
    public function writeTypeBaseField($type)
    {
        file_put_contents('type base.txt',$type);
    }

    public function writeTypeSearch($typeSearch)
    {
        file_put_contents('type search.txt',$typeSearch);
    }
